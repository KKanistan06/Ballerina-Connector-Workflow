    ...
    public static Object parseJar(Object jarPathOrResult) {
        try {
            ...
            if (jarPathOrResult instanceof BMap) {
                ...
                if (allJarsObj instanceof io.ballerina.runtime.api.values.BArray) {
                    io.ballerina.runtime.api.values.BArray allJars = 
                        (io.ballerina.runtime.api.values.BArray) allJarsObj;
            ...
            try {
                ...
                if (!requestParams.isEmpty()) {
                    paramInfo.put(StringUtils.fromString("requestFields"),
                        ValueCreator.createArrayValue(requestParams.toArray(new BMap[0]), 
                        TypeCreator.createArrayType(mapType)));
                }
            } catch (Exception e) {
